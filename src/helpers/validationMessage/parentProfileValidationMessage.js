...
const parentProfileValidationMessage = {
  ...
  dateOfDeathBase: `Date of death must be a valid date`,
  dateOfDeathRequired: `Date of death is required when parent is deceased`,
  dateOfDeathInvalid: `Date of death is required when parent is deceased and must be a past date (not today or future)`,
  ...
  caringChildByBase: `Caring child by must be a valid string`,
  caringChildByEmpty: `Caring child by cannot be empty`,
  caringChildByRequired: `Caring child by is required and must be a non-empty string when parent is deceased`,
  caringChildByMinLength: `Caring child by must be at least ${parentProfileCaringChildByMinChar} characters`,
  caringChildByMaxLength: `Caring child by cannot exceed ${parentProfileCaringChildByMaxChar} characters`,
