...
const schoolAdmissionDocumentValidationMessage = {
  ...
  schoolAdmissionDocumentNotesMinLength: `Notes must be less then ${schoolAdmissionDocumentNotesMinChar} characters`,
  schoolAdmissionDocumentNotesMaxLength: `Notes must be greater then ${schoolAdmissionDocumentNotesMaxChar} characters`,
