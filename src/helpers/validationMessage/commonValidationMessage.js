...
const commonValidationMessage = {
  firstNameBase: `First name must be a valid string`,
  ...
  lastNameBase: `Last name must be a valid string`,
  lastNameRequired: "Last name is required",
  lastNameEmpty: "Last name cannot be empty",
  lastNameInvalidFormate: "Last name must be string formate",
  ...
  emailBase: `Email must be a valid string`,
  ...
  phoneNumberBase: `Phone number must be a valid string`,
  phoneNumberRequired: "Phone number is required",
  phoneNumberEmpty: "Phone number cannot be empty",
  phoneNumberInvalid: "Phone number must contain only digits",
  ...
  aadhaarNumberBase: "Aadhaar number must be a valid string",
