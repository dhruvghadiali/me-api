...
const validateStudentUpdateUsernamePutSchema = Joi.object({
...
/**
 * @desc    Validate student update username request body
 * @param   {Object} req - Express request object
 * @param   {Object} res - Express response object
 * @param   {Function} next - Express next middleware function
 * @access  Private/Student
 */
const validateStudentUpdateUsernamePutReqBody = asyncHandler(
  async (req, res, next) => {
    try {
      await validateStudentUpdateUsernamePutSchema.validateAsync(req.body);
      next();
    } catch (err) {
      next(
        new ErrorResponse(
